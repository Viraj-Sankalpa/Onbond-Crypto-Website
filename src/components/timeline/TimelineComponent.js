...
const events = [
  {
    id: 1,
    date: addSuperscript("2nd Quarter of 2025"),
    content:
  ...
  {
    id: 2,
    date: addSuperscript("4th Quarter of 2025"),
    content:
  ...
  {
    id: 3,
    date: addSuperscript("1st Quarter of 2026"),
    content:
  ...
  {
    id: 4,
    date: addSuperscript("4th Quarter of 2026"),
    content:
  ...
  {
    id: 5,
    date: addSuperscript("2nd Quarter of 2027"),
    content:
  ...
  {
    id: 6,
    date: addSuperscript("4th Quarter of 2027"),
    content:
    ...
    const handleScroll = () => {
      ...
      if (timelineContainer && timelineEvents.length > 0) {
        ...
        for (let i = 0; i < timelineEvents.length; i++) {
          ...
          const dateTop = dateElement.getBoundingClientRect().top + window.scrollY;
          if (scrollY >= dateTop) {
            newHeight = dateTop - containerTop + dateElement.offsetHeight / 2;
          }
        }
